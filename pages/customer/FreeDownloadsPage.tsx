...
const CustomerFreeDownloads: React.FC = () => {
        ...
        {filteredDownloads.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredDownloads.map((item) => (
              <div
                key={item.id}
                className="bg-white/[0.08] border border-white/[0.06] rounded-xl overflow-hidden hover:border-blue-500 transition-all"
              >
                {/* Image */}
                ...
                <div className="p-4 space-y-3">
                  ...
                  <a
                    ...
                    download
                    className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 px-4 py-3 rounded-lg text-white font-semibold transition-all flex items-center justify-center gap-2"
                  >
                    <Download size={18} />
                    Download Free
                  </a>
...
export default CustomerFreeDownloads;
